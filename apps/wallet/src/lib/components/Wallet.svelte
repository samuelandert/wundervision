<script>
	...
	import walletMachine from '../services/walletMachine';
	import { onMount } from 'svelte';
	import Icon from '@iconify/svelte';
	import { walletState } from '../services/stores';
	import {
		signInWithGoogle,
				...
				<div class="w-full h-full overflow-hidden grid grid-cols-6">
					<aside class="col-span-1">
						...
						<div class="flex items-center space-x-2">
							<Icon icon="iconamoon:profile-circle-fill" class="w-12 h-12 text-gray-500" />
							<div>
								<div class="text-sm">
